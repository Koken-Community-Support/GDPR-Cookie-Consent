...
class KokenCommunityGDPR extends KokenPlugin {
	...
	function renderFirst() {
		...
		echo '<script class="gdprScript" id="gdpr_options">const gdprCookieName=\''.$this->data->gdprCookieName.'\';const activeForAll='.$this->data->activateAll.';const ignoredCookie=\''.$this->data->ignoreCookie.'\';</script>';
		echo '<script class="gdprScript" id="gpdr_head" src="'. $this->get_path() .'/js/gdpr-head.min.js"></script>';
	}
